...
CANSAT_DATAPRECISION = 1  # Decimal precision of the data sent (EXCLUDING GPS DATA)
...
def InitCansatCore(bmp: BMP280 = None, mpu: MPU6050 = None) -> None:
    ...
    if mpu is not None:
        ...
        CANSAT_CORRECTION_ACCELEROMETER.Y = accelerometerTotal.Y / INITALIZATION_ACCELEROMETER_MEASUREMENTS - 1.0  # The Y axis will be in the opposite direction of gravity
